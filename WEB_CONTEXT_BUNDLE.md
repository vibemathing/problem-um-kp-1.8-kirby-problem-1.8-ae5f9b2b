...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-1.8-kirby-problem-1.8-ae5f9b2b-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-1.8"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-1.8-kirby-problem-1.8-ae5f9b2b-v1",
      "problem_contract_sha256": "9d3a207626f65aae717afe2596a7d6c1d0141c0be0e6825ed0d6edcdc9f81843",
      "problem_id": "problem:um-kp-1.8-kirby-problem-1.8-ae5f9b2b",
      "route_id": "route:um-kp-1.8-kirby-problem-1.8-ae5f9b2b-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-1.8-kirby-problem-1.8-ae5f9b2b-source-fidelity-01",
      "graph_id": "graph:um-kp-1.8-kirby-problem-1.8-ae5f9b2b-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-1.8-kirby-problem-1.8-ae5f9b2b-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-1.8-kirby-problem-1.8-ae5f9b2b-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Which multi-variable Laurent polynomials arise as the multi- variable Alexander polynomial of a link in the 3-sphere or, more generally, a ho- mology 3-sphere?"
          },
          "statement_sha256": "bb040486d3512abd709fe8ff63de44543e690fd1b23e779c0db1839baef6e6b4"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-1.8-kirby-problem-1.8-ae5f9b2b-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-1.8-kirby-problem-1.8-ae5f9b2b-root",
      "route_id": "route:um-kp-1.8-kirby-problem-1.8-ae5f9b2b-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-1.8-fcd008e95dd9",
        "url": "https://www.unsolvedmath.com/problems/KP-1.8"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
